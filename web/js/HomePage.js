...
function Register(){
    ...
    oRegister.id="login";
    oRegister.innerHTML="<div class='registerCon'><br><br><br><br><form action='RegisterAction' method='post' id='form1'><input type='text' class='usernameText' name='username'><br><input type='password' class='passwordText' name='password'><br><input type='button' id='btnInnerRegister' class='innerButton' value='×¢²á'></form><div id='close'></div></div>";
